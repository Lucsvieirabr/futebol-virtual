...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///Users/leonardohumbert/Downloads/sistema-futebol-online/nuxt/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/leonardohumbert/Downloads/sistema-futebol-online/nuxt/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/leonardohumbert/Downloads/sistema-futebol-online/nuxt/node_modules/devalue/index.js';
import destr from 'file:///Users/leonardohumbert/Downloads/sistema-futebol-online/nuxt/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/leonardohumbert/Downloads/sistema-futebol-online/nuxt/node_modules/ufo/dist/index.mjs';
import { hash } from 'file:///Users/leonardohumbert/Downloads/sistema-futebol-online/nuxt/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///Users/leonardohumbert/Downloads/sistema-futebol-online/nuxt/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/leonardohumbert/Downloads/sistema-futebol-online/nuxt/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/leonardohumbert/Downloads/sistema-futebol-online/nuxt/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/leonardohumbert/Downloads/sistema-futebol-online/nuxt/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/leonardohumbert/Downloads/sistema-futebol-online/nuxt/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/leonardohumbert/Downloads/sistema-futebol-online/nuxt/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/leonardohumbert/Downloads/sistema-futebol-online/nuxt/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///Users/leonardohumbert/Downloads/sistema-futebol-online/nuxt/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/leonardohumbert/Downloads/sistema-futebol-online/nuxt/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/leonardohumbert/Downloads/sistema-futebol-online/nuxt/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/leonardohumbert/Downloads/sistema-futebol-online/nuxt/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///Users/leonardohumbert/Downloads/sistema-futebol-online/nuxt/node_modules/unctx/dist/index.mjs';
import * as vue$1 from 'file:///Users/leonardohumbert/Downloads/sistema-futebol-online/nuxt/node_modules/vue/index.mjs';
import { version, unref } from 'file:///Users/leonardohumbert/Downloads/sistema-futebol-online/nuxt/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/leonardohumbert/Downloads/sistema-futebol-online/nuxt/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/leonardohumbert/Downloads/sistema-futebol-online/nuxt/node_modules/@unhead/shared/dist/index.mjs';
    ...
    "primevue": {
      ...
      "options": {
        ...
        "locale": {
          ...
          "apply": "Aplicar",
          "close": "Fechar",
          "matchAll": "Atender todas as Regras",
          "matchAny": "Atender qualquer regra",
      ...
      "components": [
        ...
        {
          "name": "PrimeDataViewLayoutOptions",
      ...
      "injectStylesAsStringToTop": [
        "'<style type=\"text/css\" data-primevue-style-id=\"layer-order\" >@layer style, tailwind-base, primevue, tailwind-utilities</style>'"
      ]
    }
  }
};
...
const serverAssets = [{"baseName":"server","dir":"/Users/leonardohumbert/Downloads/sistema-futebol-online/nuxt/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/leonardohumbert/Downloads/sistema-futebol-online/nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/leonardohumbert/Downloads/sistema-futebol-online/nuxt/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/leonardohumbert/Downloads/sistema-futebol-online/nuxt/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/leonardohumbert/Downloads/sistema-futebol-online/nuxt/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/leonardohumbert/Downloads/sistema-futebol-online/nuxt/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _amIgclT64D = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/leonardohumbert/Downloads/sistema-futebol-online/nuxt";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _IdPMcOaIkV = (nitroApp) => {
...
const stylesToTop = ['<style type="text/css" data-primevue-style-id="layer-order" >@layer style, tailwind-base, primevue, tailwind-utilities</style>'].join('');
const styleProps = {
...
const _tkKZ7ttSvp = defineNitroPlugin(async (nitroApp) => {
...
const _lazy_1AmyO8 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_1AmyO8, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_1AmyO8, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[],"style":[],"script":[],"noscript":[],"title":"Futebol Online","charset":"utf-8","viewport":"width=device-width, initial-scale=1"};
...
const getClientManifest = () => import('file:///Users/leonardohumbert/Downloads/sistema-futebol-online/nuxt/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
